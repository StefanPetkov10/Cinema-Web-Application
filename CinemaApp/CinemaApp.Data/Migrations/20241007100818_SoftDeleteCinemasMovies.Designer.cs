...
namespace CinemaApp.Data.Migrations
{
    ...
    [Migration("20241007100818_SoftDeleteCinemasMovies")]
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.Cinema", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("74ceb1c0-9ecc-476b-a37d-70a4b6fc2299"),
                            Location = "Sofia",
                            Name = "Cinema City"
                        },
                        new
                        {
                            Id = new Guid("a7aeb602-6494-45ea-a780-5ca45d9cf1f7"),
                            Location = "Plovdiv",
                            Name = "Cine Grand"
                        },
                        new
                        {
                            Id = new Guid("07a8afc9-3adc-46fb-8969-4b39091ee30a"),
                            Location = "Varna",
                            Name = "Cinema City"
                        },
                        new
                        {
                            Id = new Guid("bd9474cd-c2de-418a-ac1b-f6887e95fe01"),
                            Location = "Burgas",
                            Name = "Cine Grand"
                        });
                });
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("449723e5-a8f6-42b2-8a1b-7d70cc6a6b0a"),
                        ...
                        new
                        {
                            Id = new Guid("cb3df481-5877-4f4e-85a6-a76026ccaaaf"),
